...
### Geiss feedback playground

Open `playground/geiss-playground.html` directly in a browser, choose a local MP3/WAV/OGG file, and tune the Geiss renderer without rebuilding the Power BI visual. It includes live controls for line mode and separation, rotation, music-driven shifting, reactivity, waveform variance, outward flow, trail persistence, comet size, and clearing accumulated feedback.
